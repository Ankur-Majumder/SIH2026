...
export function ProvidersPage({ onBook, selectedCategoryId }) {
      ...
      <div className="section-inner">
        ...
        {filtered.length === 0 ? (
          <div style={{ textAlign: "center", padding: "3rem 1rem", background: "var(--bg-card)", borderRadius: "var(--radius)", border: "1px solid var(--border)" }}>
            ...
            <div style={{ color: "var(--slate-400)", fontSize: "0.85rem", marginTop: "0.25rem" }}>Try selecting another service category from the Services page.</div>
          </div>
        ) : (
